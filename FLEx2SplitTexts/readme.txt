The splitFlextext.xsl script splits a single flextext file containing multiple texts into multiple flextext files (one per text).
The splitFlextext.bat file can be used to run the script using Saxon processor under Java on Windows.
