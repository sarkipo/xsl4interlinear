...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:variable name="tiers-sent">ref ts fe fg ltg nt</xsl:variable>
    ...
    <xsl:template match="//interlinear-text">
        ...
        <xsl:variable name="textname" select="current()/item[@type='title-abbreviation' and @lang='en']/text()"/>
            ...
            <basic-body>
                ...
                <xsl:call-template name="tier-sent">
                    <!-- ltg: Literal (source) German translation  -->
                    <xsl:with-param name="itemtype" select="'lit'"/>
                    <xsl:with-param name="lang" select="'de-x-source'"/>
                    <xsl:with-param name="cat" select="'ltg'"/>
                    <xsl:with-param name="display" select="'ltg'"/>
                    <xsl:with-param name="speaker" select="$speaker"/>
                </xsl:call-template>
                <xsl:call-template name="tier-sent">
